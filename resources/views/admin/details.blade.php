...
@section('admin-content')
    <div class="container">
        <a href="{{route('admin.orders.index')}}" class="btn btn-outline-info">Вернуться назад</a>
                        ...
                        <li class="list-group-item">
                            <div class="row mx-auto">
                                <div class="col-md text-center">
                                    <form method="post" action="{{route('admin.orders.close', ['id' => $item->id])}}">
                                        @csrf
                                        @method('PATCH')
                                ...
                                <div class="col-md text-center">
                                    <form method="post" action="{{route('admin.orders.approved', ['id' => $item->id])}}">
                                        @csrf
                                        @method('PATCH')
                                        <button class="btn btn-outline-success">Утвердить</button>
                                    </form>
                                </div>
                            </div>
